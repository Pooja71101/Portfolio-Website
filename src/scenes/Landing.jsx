...
import Image4 from "../assets/profilepic.jfif";
...
const Landing = ({setSelectedPage}) =>{
    ...
    return(
        ...
        {isAboveLarge ? (
          ...
          <img
            alt="profile"
            className="z-10 w-full max-w-[300px] md:max-w-[300px]"
            src={Image4}
          />
        )}
        </div>
      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          ...
          I'm filled with excitement to dive into new learning experiences and adventures.
         I'm eagerly looking forward to tackling tough projects that will help me stretch my abilities and showcase my potential!
          </p>
        </motion.div>
